const data = {
  ...
  workExperience: {
    ...
    entries: [
      ...
      },
      {
        ...
        description: 'Quality Assurance Analyst for EA products, with a focus on team work.',
      },
    ]
  },
  education: {
  ...
  languages: {
    ...
    entries: [
      ...
      },
      {
        ...
        description: 'First Certificate (University of Cambridge)',
      },
      {
        name: 'German',
        level: 'Beginner',
  ...
  involvement: {
    title: 'Involvement',
    description: 'I was an Assistant Professor in College. I attended several design and usability conferences, including Trimarchi and IXDA La Plata. I was also involved in several audiovisual projects, filming, editing, photographing and creating digital brands for music bands.',
  },
  findMeOn: {
    title: 'Find me on',
    entries: [
